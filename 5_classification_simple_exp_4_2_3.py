...
parser.add_argument('--model', default='3_pointAE_simple_128', help='Model name: pointnet_cls or pointnet_cls_basic [default: pointnet_cls]')
...
def train_one_epoch(sess, ops, train_writer):
    ...
    #for fn in range(1): #use only first file for less data
        ...
        for batch_idx in range(num_batches):
            ...
            #loss_sum = loss_sum + np.sum(np.square(np.subtract(pred_val, current_data_orig[start_idx:end_idx, :, :])))
